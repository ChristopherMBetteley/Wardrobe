...
namespace WardrobeMVCApp.Controllers
{
    public class BottomsController : Controller
    {
        ...
        {
            var bottoms = db.Bottoms.Include(b => b.Occasssion).Include(b => b.Season);
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomsName,BottomsPhoto,BottomsColor,BottomsType,SeasonID,OccassionID")] Bottom bottom)
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occasssions, "OccassionID", "OccassionName", bottom.OccassionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,BottomsName,BottomsPhoto,BottomsColor,BottomsType,SeasonID,OccassionID")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
