...
namespace WardrobeMVCApp.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.BottomID = new SelectList(db.Bottoms, "BottomsID", "BottomsName");
            ViewBag.ShoesID = new SelectList(db.Shoes, "ShoesID", "ShoesName");
            ViewBag.TopID = new SelectList(db.Tops, "TopsID", "TopsName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "OutfitID,OutfitName,TopID,BottomID,ShoesID,AccessoriesID")] Outfit outfit)
        {
            ...
            ViewBag.BottomID = new SelectList(db.Bottoms, "BottomsID", "BottomsName", outfit.BottomID);
            ViewBag.ShoesID = new SelectList(db.Shoes, "ShoesID", "ShoesName", outfit.ShoesID);
            ViewBag.TopID = new SelectList(db.Tops, "TopsID", "TopsName", outfit.TopID);
            return View(outfit);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,OutfitName,TopID,BottomID,ShoesID,AccessoriesID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
